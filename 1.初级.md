...
git config --global user.name "dskismvp"
git config --global user.email "376643168@qq.com"
git remote add origin git@github.com:dskismvp/dskismvp.github.io.git
git@gitee.com:dong-shaokang/h2.git
inetcpl.cpl
secpol.m
...
git config --global --get https.proxy
 git config --global --unset http.proxy
  ...
  git remote set-url origin https://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@github.com/dskismvp/dskismvp.github.io.git
```
...
```
ssh-rsa 效8B3NzaC1yC2EA-ADAQAB4&BgOFEpMJF/EXB+YFfoKDanScwapBcqajfipIh+lrdtTPgMu4b8qKk4jJ3XzHcmbiv7/9d9EfINOAnuSj5CcPGK/ADNTD3E
A+XoFH1GsJyaL2F
nIV3/tjdyICASrR6Ne/e5ZCeYX+2i5:7/NthNiFyvVkVsH2.s4/NIwT2E[1dg3eblikyH7LsTe4X+4NAInZEOjHne7lVQAIEBxVrCOmtTgOmchFlLTsoer62Buxke 'jfKmowEXCPsdj
Jeg3iI2PqAa6gMX
uNgZGicgehmb/Sq13uTpneKPYtpDCoDY+Polb84uCloxwO9P6vnUvg1m9inlNFgalUXwxG3sSGITgIaYdkgKjz05fmhwtjyizZIGEhRCHIe1cDdewKXn9Lxs65f9ALr
iH2w3121v2R2/ZAn
Wwf4NX1gy/XOFXNHY/uLARelzM2.OokztrMdon'KZzEyalkocalUkHYGM(XAP17Gz8fqPHiLGF1E51SsAAZiMAA4DR7sS8xVp3RxeB3ICBnI1Z6SICOD/jTXTX= rootiza2d8jxohfykghcggg6z
...
![image-20231218144616238](C:\Users\dsk\AppData\Roaming\Typora\typora-user-images\image-20231218144616238.png)

```

```

![image-20231218144628602](C:\Users\dsk\AppData\Roaming\Typora\typora-user-images\image-20231218144628602.png)
...
原文链接：https://blog.csdn.net/hey_lie/article/details/
